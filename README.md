...
3. Click **CONFIGURE** — the **Configure Windows** dialog opens. The first screen shows the **energy sensor** (source entity); you can change it there and click **Submit** to continue.
4. You then see the main menu. Options:
